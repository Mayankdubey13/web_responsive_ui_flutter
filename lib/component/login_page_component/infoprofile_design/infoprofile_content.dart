...
class InfoProfileContent extends StatefulWidget{
  Icon icon;
  var item;
  var item2;
  @override
   InfoProfileContent({required this.icon,
    required this.item,required this.item2
  }
      );

  @override
  State<InfoProfileContent> createState() => _InfoProfileContentState();
}

class _InfoProfileContentState extends State<InfoProfileContent> {
